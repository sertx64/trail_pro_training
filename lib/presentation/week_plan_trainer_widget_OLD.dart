...
class WeekPlanTrainerWidgetOLD extends StatefulWidget {
  const WeekPlanTrainerWidgetOLD({super.key});

  @override
  State<WeekPlanTrainerWidgetOLD> createState() => _WeekPlanTrainerWidgetOLDState();
}

class _WeekPlanTrainerWidgetOLDState extends State<WeekPlanTrainerWidgetOLD> {
